...
export const TOUR_STEPS: Record<string, TourSegment> = {
  "/": {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-muted-foreground p-2">
              Provides resources for setup as well as quick navigation (end tour
              to navigate).
            </div>
          </div>
        ),
      ...
      [TOUR_STEP_IDS.MODE_TOGGLE]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              Cycles between <em>Dark Mode</em>, <em>System Default</em>, and{" "}
              <em>Light Mode</em>.
            </div>
          </div>
        ),
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-muted-foreground p-2">
              ...
              device's <em>System</em>, <em>Exposure</em>, and <em>Image</em>.
            </div>
          </div>
        ),
            ...
            <ul className="text-sm text-muted-foreground p-2 space-y-2">
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Determines the amount of data processed per second of video.
                  Higher values yield better video quality but consume more
                  network bandwidth.
                </div>
              </li>
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Sets the interval between key-frames (I-frames) in the video
                  stream. A higher value improves compression efficiency, while
                  a lower value can reduce latency and improve stream stability
              ...
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  ...
                  bandwidth during static shots rather than pushing a constant
                  bitrate (CBR). In practice, it will use a bitrate between
                  10mbps and 70mbps.
                </div>
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="text-sm text-muted-foreground p-2 space-y-2">
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Adjusts the compression level, greatest visual clarity results
                  in greatest file size and vice versa.
                </div>
              </li>
              <li>
                <b>Strobe Width</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Defines the duration of the strobe light pulse, allowing you
                  to synchronize external lighting with the camera's exposure.
                </div>
              </li>
              <li>
                <b>ISO</b>
              ...
              <li>
                <b>Exposure Time</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Dictates how long the sensor is exposed to light per frame to
                  control brightness and motion blur.
                </div>
              </li>
              <li>
                <b>Auto Exposure</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  When enabled, the camera automatically calculates and adjusts
                  its exposure settings based on the surrounding ambient light.
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="text-sm text-muted-foreground p-2 space-y-2">
              <li>
                <b>Gain</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Artificially amplifies the video signal to increase brightness
              ...
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Adjusts the exposure to properly illuminate darker subjects
                  that are positioned against a bright background, preventing
                  them from appearing as silhouettes.
                </div>
              </li>
              <li>
                <b>Auto Exposure</b>
              ...
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  When toggled on, this allows the camera to automatically lower
                  its framerate in dark environments. This increases the
                  exposure time per frame, resulting in a brighter image at the
                  cost of video smoothness.
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="text-sm text-muted-foreground p-2 space-y-2">
              ...
              <li>
                <b>Contrast</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Modifies the difference between the lightest and darkest areas
                  of the image.
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Toggles our proprietary auto white-balance algorithm designed
                  to optimize color accuracy and clarity for underwater.
                </div>
              </li>
              <li>
                <b>Gamma</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Adjusts the brightness of the mid-tones in the video without
                  severely affecting the extreme shadows or bright highlights.
                </div>
              </li>
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  ...
                  produce cooler (more blue) tones, while higher values produce
              ...
              <li>
                <b>Sharpness</b>
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  Enhances edge detail to make the image appear crisper and more
                  defined.
                </div>
              </li>
              <li>
                ...
                <div className="border-l border-primary pl-2 ml-2 text-xs">
                  ...
                  should set this to match your local region’s electrical grid
                  frequency (e.g., 60 Hz for North America, 50 Hz for
                  Europe/Asia).
                </div>
              </li>
            </ul>
            ...
            <div className="text-sm text-muted-foreground px-2 pb-2 flex flex-col gap-2">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <b>Frame Rate</b>
                  <div className="border-l border-primary pl-2 ml-2 text-xs">
                    Determines the number of frames captured per second (FPS)
                    for video smoothness.
                  </div>
                </li>
                <li>
                  <b>Format</b>
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <ul className="text-sm text-muted-foreground p-2 flex flex-col gap-2">
              ...
              <li>
                Once added, the <em>Follower's</em> streaming and recording will
                be controlled by the <em>Leader</em> it's assigned to.
              </li>
            </ul>
          </div>
        ),
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-muted-foreground p-2 flex flex-col gap-2">
              ...
              <span>
                If this device is managed (<em>Follower</em>), this button will
                be disabled.
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-muted-foreground p-2 flex flex-col gap-2">
              ...
              <span>
                ...
                x2 <b>Double-Left-Click</b> to quickly <em>Play</em> supported
                videos.
              </span>
            </div>
          </div>
      ...
      [TOUR_STEP_IDS.RECORDINGS_FUNCTIONS]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2 flex flex-col gap-2">
              Upon selecting at least one item, the following functions become
              available to you:
              <ul className="space-y-2">
                <li>
      ...
      [TOUR_STEP_IDS.NETWORKING_PAGE]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              Welcome to the Network page. From here, you can manage both your
              wired and wireless device connections and route settings.
            </div>
          </div>
        ),
      ...
      [TOUR_STEP_IDS.WIRED_CONFIG]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              This section lists all detected wired network interfaces. You can
              view their current state and manage their connection profiles.
            </div>
          </div>
        ),
      ...
      [TOUR_STEP_IDS.NETWORK_OPTION]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              Click on a network interface to expand it. You'll see its current
              state (e.g., Connected, Disconnected) and all available connection
              profiles.
            </div>
          </div>
        ),
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-muted-foreground p-2 flex flex-col gap-2">
              ...
              <em>
                Note: Remember to click on the profile to apply your changes.
              </em>
            </div>
          </div>
        ),
      ...
      [TOUR_STEP_IDS.WIRELESS_NETWORK]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              Currently, wireless is unsupported. If your device supports Wi-Fi,
              you will be able to scan for networks and manage wireless
              connections here in future updates.
            </div>
          </div>
        ),
  ...
  "/preferences": {
    ...
    steps: {
      [TOUR_STEP_IDS.PREFS_PAGE]: {
        ...
        prevStepId: TOUR_STEP_IDS.WIRELESS_NETWORK,
      ...
      [TOUR_STEP_IDS.LOGS_PAGE]: {
        ...
        content: (
          <div className="flex flex-col gap-2">
            ...
            <Separator />
            <div className="text-sm text-muted-foreground p-2">
              The Logs page displays debug logs from across the app. Have these
              on hand when contacting support.
            </div>
          </div>
        ),
