    ...
    content: (
      <div>
        ...
        <div className="text-sm text-muted-foreground p-2">
          ...
          restart the system from within DWE OS.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          This controls the system's wired network configuration. Allows for
          customization of options like: IP Address, Gateway, Netmask etc.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          Toggles between Dark Mode, Light Mode, and System Default, influencing
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          This is a sample detected camera.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          You may give your device a name here.
        </div>
      </div>
    ),
    ...
    content: (
      <div>
        ...
        <div className="text-sm text-muted-foreground p-2">
          ...
          Resolution, Frame Rate, and Format here.
        </div>
      </div>
    ),
    ...
    content: (
      <div>
        ...
        <div className="text-sm text-muted-foreground p-2">
          ...
          and port of the device you are streaming to at hand.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          This toggles between Recording and Streaming mode. Streaming will send
          the live stream to another device, while recording will keep recorded
          videos in the recordings tab.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          This is where you start/stop your stream or recording. For streaming,
          please ensure your endpoints are correct.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          Down here you have additional details and the ability to download all
          videos in a ZIP file.
        </div>
      </div>
    ),
    ...
    content: (
      <div>
        ...
        <div className="text-sm text-muted-foreground p-2">
          ...
          endpoint. The Default Stream Port will increment automatically as you
          add new endpoints for the same Stream Host.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          This page will display anything pertaining to the devices, it will log
          occurances like device adding, device removal, device setting tweaks,
          etc.
        </div>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <Separator />
        <div className="text-sm text-muted-foreground p-2">
          A built in terminal for your convenience.
        </div>
      </div>
    ),
