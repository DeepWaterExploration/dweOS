...
# Ethernet
@wired_router.get("/get_ip_configuration", summary="Get the ethernet IP configuration")
...
@wired_router.post("/set_ip_configuration", summary="Update the ethernet IP configuration")
...
async def set_network_priority(request: Request, network_priority: NetworkPriorityInformation):
    wifi_manager: AsyncNetworkManager = request.app.state.wifi_manager
